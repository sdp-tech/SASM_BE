...
urlpatterns = [
     ...
     path('story_detail/<int:story_id>/update/', StoryUpdateApi.as_view(), name='story_update'),
     path('story_detail/<int:story_id>/delete/', StoryDeleteApi.as_view(), name='story_delete'),
     path('story_search/',

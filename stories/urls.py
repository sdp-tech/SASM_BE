...
from .views import StoryDetailApi, StoryRecommendApi, StoryLikeApi, StoryListApi, GoToMapApi, StoryCreateApi, StoryPhotoCreateApi, StoryCommentListApi, StoryCommentCreateApi, StoryCommentUpdateApi, StoryCommentDeleteApi

urlpatterns = [
    path('stories/create/', StoryCreateApi.as_view(), name='story_create'),
    path('story_photos/create/',
         StoryPhotoCreateApi.as_view(), name='story_photo'),
    path('story_like/',
         StoryLikeApi.as_view(), name="story_like"),
    path('story_detail/<int:story_id>/',
         StoryDetailApi.as_view(), name='story_detail'),
    path('story_search/',
    ...
    path('comments/delete/<int:story_comment_id>/',
         StoryCommentDeleteApi.as_view(), name='comments_delete'),
]

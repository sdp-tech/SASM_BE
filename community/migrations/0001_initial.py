# Generated by Django 4.0 on 2023-01-06 15:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supports_photos', models.BooleanField(default=False)),
                ('supports_comments', models.BooleanField(default=False)),
                ('supports_commentphotos', models.BooleanField(default=False)),
            ],
        ),
        migrations.CreateModel(
            name='Post',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('image', models.ImageField(default='comment_image.png', upload_to=community.models.get_upload_path)),
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comment_photos', to='community.postcomment')),
            ],
            options={
                'abstract': False,
            },
